...
public class SimulationUIController : MonoBehaviour
{
    ...
    public Text homeFoulsText;
    public Text awayFoulsText;
    public Text homeTimeoutsText;
    public Text awayTimeoutsText;
...
#else
    public Text eventLogPrefabText;
#endif
...
#else
            Text newItem = Instantiate(eventLogPrefabText, eventLogContainer);
#endif
            newItem.text = evt;
